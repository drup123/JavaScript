...
// const arr = ["Deadpool","Wolverine","Storm","Quick Silver"]

// arr.forEach((elements) => {
//     console.log(elements) 
// });

// arr.forEach((elements, index, Fullarray) => {
//     console.log(`${index} , ${elements} , ${Fullarray}`)
// })
...
info.forEach((element) => {
    console.log(`${element.Name}'s power is ${element.Power}`)
})